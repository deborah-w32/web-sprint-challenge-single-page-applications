...
useRouteMatch matches the URL exactly, much like Route does. It gives you access to its match data.

2. How would you explain form validation to someone who has never programmed before?

It's what allows those error messages to appear when you're using forms to know what is needed, such as "Password must be at least 6 characters long and contain 2 special characters."

3. In 1-2 sentences, define end to end testing.

End-to-end testing tests whether the flow of an application is behaving correctly from start to finish. This identifies system dependencies and maintains data integrity between your components.
